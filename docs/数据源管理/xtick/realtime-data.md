...
> **文档编号**: DS-XTICK-REALTIME
> **版本**: V1.0
> **更新日期**: 2026-07-07（2026-08-07 移入数据源管理）
> **用途**: 说明 XTick 实时 5 分钟 K 线数据的获取、存储和使用流程
> **归属**: 数据源管理 / XTick 原始接口文档（标准 API 契约见 [标准API文档.md](../标准API文档.md)，时间戳契约见 F5.2 L1）
